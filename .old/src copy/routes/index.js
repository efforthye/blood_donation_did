...
router.post('/create/donor', async (req, res) => {
    ...
    try {
        ...
        const signedData = signData(`Name: ${name}, Age: ${age}, Blood Type: ${bloodType}`, privateKey);

        // Store data on the blockchain
        const registerDonor = contract.methods.registerDonor(publicKey, name, age, bloodType);
        ...
        res.send({ success: true, transaction, signedData, publicKey });
    } catch (error) {
        console.error(error);
